...
class DisibleInput extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    render() {
        ...
        return (
            ...
            <Item style={{
                ...
                justifyContent: 'center', alignItems: 'center', width: '90%', marginTop: 7, marginBottom: 10,
...
export default connect(mapStateToProp, mapDispatchToProp)(DisibleInput);
