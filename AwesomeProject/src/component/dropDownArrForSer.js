...
class DropDownArrSer extends Component {
    constructor(props) {
        super(props)
        this.state = {
        ...
        return (
            <View style={{ height: "3%" }}>
                ...
                <Item style={{
                    ...
                    <Button bordered success style={{ height: "65%", width: "20%", justifyContent: "center", alignItems: "center", marginTop: "2%", marginLeft: "8%" }} onPress={this.createOption.bind(this)}>
                    ...
                    <Button bordered warning style={{ height: "65%", width: "20%", justifyContent: "center", alignItems: "center", marginTop: "2%", marginLeft: "8%" }} onPress={this.editOption.bind(this)}>
                    ...
                    <Button bordered danger style={{ height: "65%", width: "20%", justifyContent: "center", alignItems: "center", marginTop: "2%", marginLeft: "8%" }} onPress={this.delOption.bind(this)}>
                        {/* <Image style={{ width: 23, height: 23, }}
                ...
                >
                    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                        ...
                        <Button block info style={styles.button} onPress={this._saveOptions.bind(this)} >
                            <Text style={{ marginTop: "3%" }}>{strInReqLan.createOption}</Text>
                        </Button>
                                    ...
                                    this.props.dropDownList.map((key, index) => {
                                        ...
                                        for (var prop in key) {
                                            return (
                                                ...
                                                <View style={{
                                                    borderBottomWidth: 0.3, borderColor: 'white', height: 45
                                                }}>
                ...
                >
                    <View style={{ flex: 1 }}>
                        <View style={styles.container}>
                            <Text style={{ fontWeight: "bold", fontSize: 22, color: "white", textDecorationLine: "underline" }}>{strInReqLan.tapToDelete}</Text>
                            {
...
export default connect(mapStateToProp, mapDispatchToProp)(DropDownArrSer);
