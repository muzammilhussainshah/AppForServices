...
class FullCard extends Component {
    ...
    render() {
        ...
        console.log(this.props.navigation.getParam('viewReport'), "wwwwww")
        if (this.props.navigation.getParam('viewReport').length !== 0) {

            viewReport = this.props.navigation.getParam('viewReport');
                    ...
                    <Tab heading={strInReqLan.jobService} tabStyle={{ backgroundColor: '#E61825' }} textStyle={{ color: '#fff' }} activeTabStyle={{ backgroundColor: '#E61825' }} activeTextStyle={{ color: '#fff', fontWeight: 'normal' }}>
                        ...
                        <View style={{ flex: 8, backgroundColor: "white" }}>
                            ...
                            <View style={{ marginTop: "2%" }} >
                                {
                                    (this.props.jobListArr.length >= this.props.index + 1) ? (
                                                    ...
                                                    (
                                                        ...
                                                        <ScrollView contentContainerStyle={styles.contentContainer} >
                                                            <Item style={styl.inputForService}>
                                                                ...
                                                                {/* <Icon name='user-cog' style={{ marginRight: 20, fontSize: 22, color: "#004D94" }} /> */}
                                                            ...
                                                            <Item style={styl.inputForSignForService}>
                                                                <Text style={{ fontSize: 15, marginHorizontal: "3%", textDecorationLine: "underline" }}>{strInReqLan.signature}</Text>
                                                    ...
                                                    (
                                                        ...
                                                        <ScrollView contentContainerStyle={styles.contentContainer} >
                                                            ...
                                                            <Item style={{ justifyContent: "space-between", height: "16%", marginLeft: "5%", marginRight: "5%" }}  >
                                                                ...
                                                                <Text style={{ width: "80%", fontSize: 15, marginHorizontal: "3%" }} >{viewJob.address}</Text>
                                                                <Right>
        ...
        (
            <Button block info style={styl.button} >
                <Text style={styles.btnTextMargin}>{strInReqLan.submitPost}</Text>
                                ...
                                <FooterTab style={{ backgroundColor: "#E61825", }}>
                                    <Button vertical onPress={() => this.props.navigation.navigate("EditPost", { vewJob: JSON.stringify(viewJob) })}>
                                        {/* <Image style={{ width: 23, height: 23, }}
                                            ...
                                            resizeMode="contain"
                                        /> */}
                                        <TouchableOpacity onPress={() => this.props.navigation.navigate("EditPost", { vewJob: JSON.stringify(viewJob) })}>
                                            <MaterialIcons name='edit' style={{ fontSize: 22, color: "white" }} />
                                        </TouchableOpacity>
                                    ...
                                    <Button vertical onPress={this.deletePost.bind(this, this.props.index)}>
                                        {/* <Image style={{ width: 23, height: 23, }}
                                            ...
                                            resizeMode="contain"
                                        /> */}
                                        <TouchableOpacity onPress={this.deletePost.bind(this, this.props.index)}>
                                            <MaterialIcons name='delete' style={{ fontSize: 22, color: "white" }} />
                                        </TouchableOpacity>
                                    </Button>
                                </FooterTab>
                            </Footer>
                            ...
                            >
                                {
                                    ...
                                    (viewPr !== undefined) ?
                                        ...
                                        <Text style={{ fontWeight: "bold", fontSize: 30, padding: 20, textAlign: "center", opacity: 0.1 }}>
                                            {strInReqLan.thisJobServiceHaveNoPR}
                    ...
                    {/* repooooooooooooooortttttttttttttttttttttttttt */}
                    {/* repooooooooooooooortttttttttttttttttttttttttt */}
                    {/* repooooooooooooooortttttttttttttttttttttttttt */}
                    {/* repooooooooooooooortttttttttttttttttttttttttt */}
                    {/* repooooooooooooooortttttttttttttttttttttttttt */}
                    ...
                    <Tab heading={strInReqLan.Report} tabStyle={{ backgroundColor: '#E61825' }} textStyle={{ color: '#fff' }} activeTabStyle={{ backgroundColor: '#E61825' }} activeTextStyle={{ color: '#fff', fontWeight: 'normal' }}>
                        <ScrollView contentContainerStyle={{
                            ...
                            {(viewReport !== "" && viewReport !== null && viewReport !== undefined) ?
                                (

                                    viewReport.map((report, index) => {
                                        console.log(report, "reportobjjjjjjjjjj")
                                        return (
                                            <View style={styles.reportCard} key={index}>
                                                <TouchableOpacity onPress={() => this.props.navigation.navigate("FullReport",

                                                    {
                                                        ...
                                                        viewReport: JSON.stringify(report)
                                                    }
                                                )} >
                                                    ...
                                                    <View style={{ justifyContent: "space-between", height: 30, borderBottomColor: "grey", borderBottomWidth: 0.5, flexDirection: "row" }} >
                                                        ...
                                                        <Text style={{ fontSize: 15, marginHorizontal: "3%" }}>{report.type}</Text>
                                                        {/* <Image style={{ width: 22, height: 17, marginRight: 20 }}
                                                        source={require('../assets/images/service-logo-blue.png')}
                                                        resizeMode="contain"
                                                    /> */}
                                                    ...
                                                    <View style={{ marginVertical: "2%", justifyContent: "space-between", height: 35, borderBottomColor: "grey", borderBottomWidth: 0.5, flexDirection: "row" }} >
                                                        <Text style={{ fontSize: 15, marginHorizontal: "3%" }}>{report.title}</Text>
                                                        {/* <Image style={{ width: 22, height: 17, marginRight: 20 }}
                                                        source={require('../assets/images/jobTitle.png')}
                                                        resizeMode="contain"
                                                    /> */}
                                                    ...
                                                    <View style={{ marginVertical: "1%", justifyContent: "space-between", height: 35, borderBottomColor: "grey", borderBottomWidth: 0.5, flexDirection: "row" }} >
                                                        <Text style={{ fontSize: 15, marginHorizontal: "3%" }}>{report.name}</Text>
                                                        {/* <Image style={{ width: 22, height: 17, marginRight: 20 }}
                                                        source={require('../assets/images/master_icon.png')}
                                                        resizeMode="contain"
                                                    /> */}
                                ...
                                (
                                    <Text style={{ marginTop: 17, fontWeight: "bold", fontSize: 30, padding: 20, textAlign: "center", opacity: 0.1 }}>
                                        {strInReqLan.thisJobServiceHaveNoReport}
                                    </Text>
                                )}
...
export default connect(mapStateToProp, mapDispatchToProp)(FullCard);
